...
<ul>
	...
	<?php if ( function_exists( 'fetch_feed' ) ) {
		...
		$rss = fetch_feed( 'http://www.bravenewcode.com/support/rss/forum/wptouch2' );		
	    ...
	    if ( $max_items == 0 ) {
	    	echo __( '<li class="ajax-error">No feed items found to display.</li>', 'affil4you_libs_wptouch2' );
		} else {
