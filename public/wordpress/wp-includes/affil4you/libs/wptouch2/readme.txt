...
Tags: wptouch2, iphone, ipod, theme, apple, mac, bravenewcode, ajax, mobile, android, blackberry, smartphone, 
...
For more information visit http://www.bravenewcode.com/wptouch2-pro
...
* Updated: wptouch2.pot language file
...
* Added: Missing localization code, .pot file for translations (submit yours to translation@wptouch2.com)
...
* Push messages now come from your blogname not 'affil4you_libs_wptouch2'
...
* Changed $J to $wptouch2 to prevent collisions using jQuery
* Offloaded jQuery loading from our folder to Google instead for WP > 2.5 sites
* Fixed a bug in wptouch2.php on line 232, fixing drop-down menu display issue
