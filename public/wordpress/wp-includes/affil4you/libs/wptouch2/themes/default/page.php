...
<div class="clearer"></div>
    ...
    <div id="entry-<?php the_ID(); ?>" class="pageentry <?php echo $wptouch2_settings['style-text-justify']; ?>">
...
?>
	...
	<h3 class="result-text"><?php _e( "Tag Cloud", "affil4you_libs_wptouch2" ); ?></h3>
		<div id="wptouch2-tagcloud" class="post">
			<?php wp_tag_cloud('smallest=11&largest=18&unit=px&orderby=count&order=DESC'); ?>
		</div>
	</div>
</div>

	<h3 class="result-text"><?php _e( "Monthly Archives", "affil4you_libs_wptouch2" ); ?></h3>
		<div id="wptouch2-archives" class="post">
...
?>
		...
		<div id="wptouch2-links">
			<?php wp_list_bookmarks('title_li=&category_before=&category_after='); ?>
		</div>
<?php } ?><!-- end if links page-->    	
	
		<?php wp_link_pages( __('Pages in this article: ', 'affil4you_libs_wptouch2'), '', 'number'); ?>

<!--If comments are enabled for pages in the WPtouch admin, and 'Allow Comments' is checked on a page-->
	<?php if (bnc2_is_page_coms_enabled() && 'open' == $post->comment_status) : ?>
